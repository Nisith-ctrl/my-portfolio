    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-background font-sans">
      ...
      <nav className="border-b border-white/10 bg-background/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6 text-sm font-mono text-gray-400">
            ...
            <a href="#achievements" className="hover:text-primary transition-colors">./achievements.sh</a>
      ...
      <main className="max-w-6xl mx-auto px-6 py-20 space-y-32">
        ...
        <section id="about" className="flex flex-col items-start justify-center min-h-[60vh] space-y-6">
          <div className="inline-block px-3 py-1 border border-primary/30 bg-primary/10 text-primary font-mono text-sm rounded-full mb-4">
            <span className="animate-pulse mr-2">●</span> Class of 2028 | 4.0 GPA
          </div>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
            Hi, I'm <span className="text-primary glow-text">Nisith Abeywardana</span>
          </h1>
          <h2 className="text-2xl md:text-3xl text-gray-400 font-light">
            Cybersecurity Enthusiast & CSIT Magnet Student
          </h2>
          <p className="max-w-2xl text-gray-500 leading-relaxed text-lg">
          ...
          <div className="flex gap-4 pt-6">
            <a href="#contact" className="px-6 py-3 bg-primary text-background font-semibold rounded hover:bg-primary/90 transition-all font-mono">
              Initialize Contact
            </a>
            <a href="#achievements" className="px-6 py-3 border border-white/20 hover:border-primary/50 hover:text-primary text-white font-semibold rounded transition-all font-mono">
              View Achievements
            </a>
          </div>
        </section>
        ...
        <section id="skills" className="space-y-8">
          <h3 className="text-3xl font-bold font-mono border-b border-white/10 pb-4 inline-block">
            <span className="text-primary">#</span> cat skills_and_certs.txt
          </h3>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {["CompTIA Tech+", "ITS Device Configuration", "CIW JavaScript Specialist", "Javascript Coding Specialist"].map(cert => (
                  <span key={cert} className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 font-mono hover:border-primary/50 hover:text-primary transition-colors cursor-default">
                    {cert}
                  </span>
                ))}
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-4">
              <div className="p-5 border border-white/5 bg-white/5 rounded backdrop-blur-sm hover:border-primary/30 transition-colors">
        ...
        <section id="achievements" className="space-y-8">
          <h3 className="text-3xl font-bold font-mono border-b border-white/10 pb-4 inline-block">
            <span className="text-primary">#</span> ls -la /honors_and_achievements
          </h3>
          <div className="grid md:grid-cols-1 gap-6">
            <div className="group p-6 border border-white/10 bg-gradient-to-br from-white/5 to-transparent rounded-lg hover:border-primary/50 transition-all duration-300">
              <div className="flex justify-between items-start mb-4">
                <div className="font-mono text-sm text-primary">01_CyberPatriot.exe</div>
            ...
            <div className="group p-6 border border-white/10 bg-gradient-to-br from-white/5 to-transparent rounded-lg hover:border-primary/50 transition-all duration-300">
              <div className="flex justify-between items-start mb-4">
                <div className="font-mono text-sm text-primary">02_Lockheed_Martin.exe</div>
            ...
            <div className="group p-6 border border-white/10 bg-gradient-to-br from-white/5 to-transparent rounded-lg hover:border-primary/50 transition-all duration-300">
              <div className="flex justify-between items-start mb-4">
                <div className="font-mono text-sm text-primary">03_FBLA_Cybersecurity.exe</div>
        ...
        <section id="leadership" className="space-y-8">
          <h3 className="text-3xl font-bold font-mono border-b border-white/10 pb-4 inline-block">
            <span className="text-primary">#</span> ./execute_leadership.sh
          </h3>
          
          <div className="grid md:grid-cols-2 gap-6">
            {/* Leadership */}
            <div className="space-y-4">
              <div className="p-6 border border-white/5 bg-white/5 rounded backdrop-blur-sm">
            ...
            <div className="p-6 border border-white/5 bg-white/5 rounded backdrop-blur-sm h-full">
              <h4 className="text-white font-bold mb-4 text-xl">Activities & Interests</h4>
      ...
      {/* Footer */}
      <footer id="contact" className="border-t border-white/10 mt-32 py-12 text-center text-gray-500 font-mono text-sm bg-black/20">
        <div className="max-w-4xl mx-auto px-6">
          <h3 className="text-2xl font-bold text-white mb-6 font-sans">Initiate Connection</h3>
          <p className="mb-2">Location: Tampa, FL</p>
          <p className="mb-2">Phone: (656) 231-0894</p>
          <p className="mb-6 text-primary">Email: nisithabeywardana@gmail.com</p>
          
          <div className="mt-8 flex justify-center space-x-6 text-gray-400">
            <a href="mailto:nisithabeywardana@gmail.com" className="hover:text-primary transition-colors hover:glow-text">
              [ Send Email ]
            </a>
          </div>
        </div>
